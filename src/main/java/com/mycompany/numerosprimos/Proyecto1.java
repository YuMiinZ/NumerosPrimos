...
public class Proyecto1 {
    ...
    //Función recursiva para calcular los coeficientes "x", "y" de la ecuación de Bezout
    ...
    public static int euclidesExtendido(int a, int b) {
        ...
        else //llamada recursiva a euclidesExtendido con b como el nuevo a y a % b como el nuevo b.
    ...
    public static void main(String[] args) {
        ...
        //Punto 2. Encontrar inversos con n primo usando el algoritmo de euclides extendido
